    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('ciudadano', 'Ciudadano'), ('administrador', 'Administrador')], default='ciudadano', max_length=20, verbose_name='Rol')),
                ('notificaciones_email', models.BooleanField(default=True, verbose_name='Recibir notificaciones por correo')),
